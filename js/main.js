// var demare = document.querySelector(".demar");
// var quizz = document.querySelector(".commence");

// demarrerLeQuiz.addEventListener('click', () => {
...
let premier = document.querySelector("#demarer");
let sujet = document.querySelector("#sujet");
var demarerLeQuiz = document.querySelector("#btn-change");
